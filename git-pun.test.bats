#!/usr/bin/env bats
# commenting this stuff out, this test will fail on CI due to auth errors
# I recommend only running this spec on a forked repo you own
#
# load './helpers'
#
# setup() {
...
@test "git-pun creates a remote branch and pushes" {
  skip # can't leave this test going in CI, it'll fail authentication
